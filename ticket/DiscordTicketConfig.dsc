discord_ticket_config:
    ...
    messages:
        ...
        rating-recorded-1:
            ...
            description: **Feedback by**: <[user].mention><n>**Rate**: ⭐ 1 Star<n>**Ticket ID**: `<[channel].flag[ticket_id].if_null[-]>`
            color: lime
        rating-recorded-2:
            title: <[channel].flag[ticket_claimer].name> has recieved a feedback!
            description: **Feedback by**: <[user].mention><n>**Rate**: ⭐ 2 Star<n>**Ticket ID**: `<[channel].flag[ticket_id].if_null[-]>`
            color: lime
        rating-recorded-3:
            title: <[channel].flag[ticket_claimer].name> has recieved a feedback!
            description: **Feedback by**: <[user].mention><n>**Rate**: ⭐ 3 Star<n>**Ticket ID**: `<[channel].flag[ticket_id].if_null[-]>`
            color: lime
        rating-recorded-4:
            title: <[channel].flag[ticket_claimer].name> has recieved a feedback!
            description: **Feedback by**: <[user].mention><n>**Rate**: ⭐ 4 Star<n>**Ticket ID**: `<[channel].flag[ticket_id].if_null[-]>`
            color: lime
        rating-recorded-5:
            title: <[channel].flag[ticket_claimer].name> has recieved a feedback!
            description: **Feedback by**: <[user].mention><n>**Rate**: ⭐ 5 Star<n>**Ticket ID**: `<[channel].flag[ticket_id].if_null[-]>`
            color: lime
