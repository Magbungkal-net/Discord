    ...
    events:
        ...
        - if <[text].starts_with[<[verify_command]>]>:
            ...
            - else:
                ...
                - ~discordmessage id:magbungkal reply:<[message]> rows:<list_single[<[button_list]>]> <[message_embed].with[color].as[#7C4751]>
...
#     - define message <context.new_message>
#     - define text <[message].text>
#     - define parse <element[<[text]>].parsed>
#     # - ~discordmessage id:magbungkal channel:1212849029667627028 reply:<[message]> "```yml<n><[parse]>```"
#     - definemap button_map:
#         1:
#           style: link
#           id: https://meta.denizenscript.com/
