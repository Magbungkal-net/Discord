discord_role_add_config:
    ...
    available-roles:
	    full access: 1182334594293452840
        ...
        beta tester: 1265183750308761651
    messages:
        not-authorized:
            title: ❌ You are not authorized to use this command
            color: maroon
        role-not-found:
            title: ❌ The role you are trying to add does not exist
            color: maroon
        role-added:
            title: ✔️ The role has been added to the user
            color: lime
        no-mentioned-users:
            title: ❌ No mentioned users
            color: maroon
        already-has-role:
            title: ❌ The user already has the role
            color: maroon
