discord_suggestion_config:
    ...
    formats:
        ...
        approved:
            ...
            # thumbnail: <context.user.avatar_url>
        ...
        text-too-small:
            ...
            title: ❌ Your suggestion is too small!
            color: maroon
        limit-reached:
        ...
        no-suggestion:
            ...
            title: ❌ Suggestion does not exist, or was already denied/approved
            color: maroon
        cant-use-command:
...
discord_suggestion_events_handler:
    ...
    events:
        ...
        - if <[text].starts_with[<[suggest_command]>]>:
            ...
            - define embed_message <discord_embed.with_map[<[suggestion_format]>].with[color].as[#7C4751]>
        ...
        - if <[text].starts_with[<[approve_command]>]> || <[text].starts_with[<[deny_command]>]>:
            ...
            - if <[command]> == <[approve_command]>:
                - definemap approve_message_map:
                    color: lime
                    title: ✔️ Suggestion Approved!
                    description:  Hello there, your suggestion has been approved!<n><n>We will now try to work for this feature you asked for.
                    footer: <context.new_message.author.name> - play.magbungkal.net
                    footer_icon: <context.new_message.author.avatar_url>
            ...
            - if <[command]> == <[deny_command]>:
                - definemap denied_message_map:
                    ...
                    description:  Hello there, your suggestion has been denied!<n><n>Sorry, your suggestion is not possible or we don't have ability to add this feature you asked for.
                    footer: <context.new_message.author.name> - play.magbungkal.net
                    footer_icon: <context.new_message.author.avatar_url>
